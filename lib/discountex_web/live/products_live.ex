        ...
        <div :for={product <- @products} class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
          ...
          <div class="h-48 bg-gray-200 rounded-t-lg overflow-hidden">
            <img 
              ...
              loading="lazy"
            />
            <div :if={product.image_url == ""} class="h-full flex items-center justify-center">
          ...
          <div class="p-4">
            ...
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center space-x-2">
                ...
                <span :if={product.discount_price && product.discount_price != product.price} class="text-sm text-gray-500 line-through">
